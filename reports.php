...
$report_groups = [
    'Accounting' => [
        ['payroll-register',       'Payroll Register',        'ri-file-list-3-line',       '#009688', 'Per-run register: gross, contributions, deductions, loans, tax and net pay for every employee.'],
...
<style>
    ...
    .rep-group-title { font-size:12px; text-transform:uppercase; letter-spacing:.5px; color:#009688; font-weight:800; margin:18px 0 10px; }
</style>
...
<div class="container-fluid">
    ...
    <div class="row mb-2"><div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between bg-galaxy-transparent">
            <h4 class="mb-sm-0"><i class="ri-bar-chart-box-line me-2" style="color:#009688;"></i>Reports</h4>
